...
export const createWarrior = (slotId) => {
    return {
        id: uuidv4(),
        name: 'warrior',
        team: 'player',
...
export const createHealer = (slotId) => {
    return {
        id: uuidv4(),
        name: 'healer',
        team: 'player',
...
export const createGoblin = (slotId) => {
    return {
        id: uuidv4(),
        name: 'goblin',
        team: 'enemy',
...
//# sourceMappingURL=create-units.js.map